...
This is a Springboot restuarant table reservation app that does not have a GUI, and uses in-memory h2 database, and exposes the end points listed in the test section.
